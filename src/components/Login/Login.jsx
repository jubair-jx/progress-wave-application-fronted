  ...
  return (
    <div>
      <section className="mb-4">
        <div className=" flex h-full flex-wrap items-center bg-white justify-center lg:justify-center">
                ...
                <div className="w-full  bg-gradient-to-r from-gray-200 to-lime-100 rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0  dark:border-gray-700">
                  <div className="p-6 text-gray-800 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    >
                      ...
                      <button
                        type="submit"
                        className="w-full mt-5 text-md bg-violet-900 text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                      >
                        Sign in
                      </button>
